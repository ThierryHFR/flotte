...
if (isset($_POST['btn-sav'])) {
   if ($_REQUEST['action'] == 'update') {
      $id = $_POST['id'];
      $nom = $_POST['nom'];
      $sql = "UPDATE marque SET nom = '$nom' WHERE id='$id';";
      $conn->query($sql);
      if ($conn->errno) {
...
if (isset($_REQUEST['id'])) {
  $sql = "SELECT id, nom FROM marque WHERE id = ".$_REQUEST['id']." ";
  $result = $conn->query($sql);
   ...
   <div class="container">
     ...
     <div class="marque-form">
        ...
        <form id="w0"  method="post">
           ...
           <div class="form-group field-marque-nom required">
